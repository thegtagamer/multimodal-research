...
def evaluate_model(test_data):
    ...
    with open("gpt_text_evaluation_results_zs.txt", "w") as file:
        file.write(results_text)
    print("📁 Results saved to `gpt_text_evaluation_results_zs.txt`")

    with open("gpt_text_evaluation_results_zs.csv", "w", newline='', encoding='utf-8') as csvfile:
        writer = csv.writer(csvfile)
        writer.writerows(csv_rows)
    print("📁 CSV saved to `gpt_text_evaluation_results_zs.csv`")
