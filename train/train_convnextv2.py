...
from transformers import AutoImageProcessor, AutoModelForImageClassification, ConvNextV2Config
...
class DisasterImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # **Process using ConvNeXt V2 processor (No Manual Normalization)**
...
processor = AutoImageProcessor.from_pretrained("facebook/convnextv2-large-22k-384")  # ✅ Load ConvNeXt V2 processor
...
# ✅ **Fix: Replace Classification Head to Prevent Mismatch**
config = ConvNextV2Config.from_pretrained("facebook/convnextv2-large-22k-384", num_labels=num_classes)
...
for param in model.convnextv2.parameters():
    param.requires_grad = False  # ✅ Freezing ConvNeXt backbone initially
...
def train_model(model, train_dataloader, test_dataloader, optimizer, criterion, scheduler, epochs=10):
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            counter = 0
            torch.save(model.state_dict(), "./models/best_convnextv2_image_classifier.pth")  # ✅ Save best model
