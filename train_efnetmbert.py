...
train_dir = "/scratch/adey6/multimodal-research/split_dataset/train"
test_dir = "/scratch/adey6/multimodal-research/split_dataset/test"
...
def train_model(model, train_loader, test_loader, optimizer, criterion, scheduler, epochs=10):
    ...
    for epoch in range(epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            counter = 0
            torch.save(model.state_dict(), "best_effnet_bert_model.pth")
